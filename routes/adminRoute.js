...
const { renderDashboard,renderArtists,updateArtist,renderCreateArtistForm, deleteArtist, renderEditArtistForm, renderArtistSearch, searchArtist, createArtist } = require("../controllers/adminController");
